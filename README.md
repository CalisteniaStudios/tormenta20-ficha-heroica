...
- O mestre configura a **logo da campanha**, seu tamanho e posição, o **título da campanha** e o **nome do grupo** em **Configurações do módulo → Identidade da campanha**. A ficha aberta acompanha a escala e a posição em tempo real enquanto os controles são movidos. A escala amplia somente a logo, sem alterar a largura ou o enquadramento do retrato da personagem, e chega a **3×**. Fechar a configuração sem salvar restaura o enquadramento anterior. Esses dados ficam salvos no mundo e são compartilhados com todos.
