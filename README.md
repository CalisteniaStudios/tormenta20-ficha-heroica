...
- O mestre configura a **logo da campanha**, seu tamanho e posição, o **título da campanha** e o **nome do grupo** em **Configurações do módulo → Identidade da campanha**. A escala amplia somente a logo, sem alterar a largura ou o enquadramento do retrato da personagem, e agora chega a **3×**. Esses dados ficam salvos no mundo e são compartilhados com todos.
